...
public class DeleteUserAndCloudDataPageController implements Initializable {
...
//                    registerStage.setY(event.getScreenY() - FrontEndApplication.oldScreenY + FrontEndApplication.oldStageY);
    ...
    public void resetUserEmailButtonOnAction(ActionEvent event) {
        ...
        resetUserEmailButton.setFont(Font.font("Times New Roman"));
        resetUserEmailButton.setText("The function has not been realization");

    }

    public void resetUserNameButtonOnAction(ActionEvent event) {

        resetUserNameButton.setFont(Font.font("Times New Roman"));
        resetUserNameButton.setText("The function has not been realization");

    }

    public void resetPasswordButtonOnAction(ActionEvent event) {

        resetPasswordButton.setFont(Font.font("Times New Roman"));
        resetPasswordButton.setText("The function has not been realization");
