...
public class UserManagementPageDatabaseConnection {
    ...
    public boolean search(String user_id, String user_encryptedpassword) {
        ...
        try {
            ...
            String sql = "SELECT * FROM `users` WHERE user_id = '" + user_id + "' AND user_encryptedpassword = '"
